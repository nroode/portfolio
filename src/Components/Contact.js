            ...
            <div className="projects-section">
                <div>
                    ...
                    <div className="contact-section-links">
                        ...
                        <a href="https://github.com/nroode" target="_blank"><i className="fab fa-github"></i>github.com/nroode</a>
                        <a href="https://www.linkedin.com/in/natalie-roode-2b19628/" target="_blank"><i className="fab fa-linkedin-in"></i>LinkedIn</a>
                    </div>
                </div>
            </div>
